  ...
  return (
    <div className="mt-20">
      <div className="grid lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-1">
        <div className="mx-auto text-center hover:shadow-2xl shadow-md p-10 rounded-2xl">
          <div className="relative w-34 h-34">
            <img className="lg:w-64 lg:h-64 md:w-20 md:h-64  sm:w-20 sm:h-64 rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
          </div>
          <div className="mt-5">
            <h1 className="text-xl">Jose Armando Cresencio Rico</h1>
          </div>
          <div className="mt-5 flex items-center">
            <h1 className="text-sm font-bold">
              Numero de Control:&nbsp;
            </h1>
            <span className="text-gray">88839002876</span>
          </div>
        </div>
        <div className="mx-auto text-center hover:shadow-2xl shadow-md p-10 rounded-2xl">
          <section className="container px-4 mx-auto">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <div className="flex items-center mt-4 gap-x-3">
                <button type="submit" className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto hover:bg-gray-100 ">
                ...
                <button type="submit" className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600">
            ...
            <div className="mt-6 md:flex md:items-center md:justify-between">
              <div className="inline-flex overflow-hidden bg-white border divide-x rounded-lg rtl:flex-row-reverse">
                <button type="submit" className="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 bg-gray-100 sm:text-sm">
                  View all
                </button>
                <button type="submit" className="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 sm:text-sm hover:bg-gray-100">
                  Monitored
                </button>
                <button type="submit" className="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 sm:text-sm hover:bg-gray-100">
                  Unmonitored
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          <th scope="col" className="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500">
                            <button type="submit" className="flex items-center gap-x-3 focus:outline-none">
                              <span>Company</span>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        <tr>
                          ...
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                            <button type="submit" className="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg hover:bg-gray-100">
